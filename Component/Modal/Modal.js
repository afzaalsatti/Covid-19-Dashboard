...
export default function App(props){
  ...
  <div style={{position:'absolute',right:0,color:'white',top:0}}>{(props.confirmed-(props.latestRecovered+props.latestDeaths))}</div>
  ...
  <div style={{marginBottom:8}}>  
    <div style={{color:'white'}}>Recovered:</div>
     <div style={{position:'absolute',right:0,color:'white',top:35}}> {props.latestRecovered}</div>
    ...
    <div style={{position:'absolute',right:0,color:'white',top:70}}> {props.latestDeaths}</div>
