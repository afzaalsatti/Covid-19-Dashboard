...
export default class mainPage extends React.Component {
  ...
  getMenuSelection(pageToBeLoaded) {
    ...
    if (pageToBeLoaded === "home") {
      ...
      if (
        ...
        <Precautions darkMode={this.state.darkMode}></Precautions>
      ) {
        this.setState({
          component: <Precautions darkMode={this.state.darkMode}></Precautions>,
        });
  ...
  render() {
    ...
    return (
      <div
        className={this.state.darkMode ? "rightDark " : "right "}
      ...
      >
        ...
        <div>
          <div
            className={
              this.state.darkMode
                ? "rightDark shadow-lg p-3 mb-5 rounded"
                : "right shadow-lg p-3 mb-5 rounded"
            }
            id="right"
            style={{ display: "none" }}
          >
            <ul
              className={
                this.state.darkMode ? "home-nav-ulDark" : "home-nav-ul"
              }
            >
              <li
                className={
                  this.state.darkMode ? "home-nav-itemDark" : "home-nav-item"
                }
                onClick={() => this.getMenuSelection("home")}
              >
                <img
              ...
              <li
                ...
                onClick={() => this.getMenuSelection("Stats")}
              >
                <img
                  style={{ height: "25px", width: "25px" }}
                  src="/assets/stats_icon.png"
                ></img>
                <span>Stats</span>
              </li>
              <li
                ...
                onClick={() => this.getMenuSelection("Map")}
              >
                <img
                  style={{ height: "25px", width: "25px" }}
              ...
              <li
                ...
                onClick={() => this.getMenuSelection("Precautions")}
              >
                <img
                  style={{ height: "25px", width: "25px" }}
                  src="/assets/precaution_icon.png"
                ></img>{" "}
        ...
        <div className="left">
          {this.state.component.type.name === "App" ? (
            <Stats darkMode={this.state.darkMode}></Stats>
          ) : this.state.component.type.name === "Preventions" ? (
            <Precautions darkMode={this.state.darkMode}></Precautions>
          ) : (
            this.state.component
          )}
        ...
        {this.state.component.type !== MapBox ? (
          <Footer id="footer" darkMode={this.state.darkMode}></Footer>
        ) : (
          ""
        )}
      </div>
