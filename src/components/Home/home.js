...
export default class home extends Component {
  constructor(props) {
    ...
    this.state = {
      images: ["/assets/p1.jpg", "/assets/p4.png", "/assets/p3.png"],
        ...
        <div style={{ marginTop: "130px" }} className="main_body">
          ...
          >
            <Card
              ...
              data={this.state.totalConfirmedLatest}
            />
          </div>
          <div
            style={{ marginRight: "18px", marginBottom: "18px", float: "left" }}
          >
            ...
            <Card
              ...
              data={this.state.totalRecoveredLatest}
            />
          </div>
          <div
            style={{ marginRight: "18px", marginBottom: "18px", float: "left" }}
          >
            ...
            <Card
              Case="Expire/Death Cases"
              data={this.state.totalDeathsLatest}
            />
          </div>
        </div>
      </div>
